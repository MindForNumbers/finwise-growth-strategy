        ...
        <div className="mt-5 rounded-3xl surface-card p-6">
          ...
          <p className="mt-2 text-[17px] font-semibold leading-relaxed tracking-[-0.01em] sm:text-[19px]">
            {monthlyDelta === 0
              ...
              : monthlyDelta > 0
                ? `System Impact: Hitting a ${cogs}% COGS target and ${labor}% labor ratio recovers ${money(monthlyDelta)} in monthly liquidity, ${dayShift === 0 ? "holding the Zero Cash Date beyond the 90-day horizon" : `extending the Zero Cash Date by ${Math.abs(dayShift)} days`}.`
